package com.melardev.spring.cloud.rest.controllers;


import com.melardev.spring.cloud.rest.dtos.responses.ErrorResponse;
import com.melardev.spring.cloud.rest.entities.Todo;
import com.melardev.spring.cloud.rest.messaging.KafkaProducer;
import com.melardev.spring.cloud.rest.repositories.TodosRepository;
...
public class TodosController {
    ...
    public ResponseEntity<Todo> create(@Valid @RequestBody Todo todo) {
        ...
        kafkaSender.sendCreated(savedTodo);
